...
public class RoomController {
	...
	// add room
	@PostMapping("/save")
	public ResponseEntity<Room> addRoom(@RequestBody RoomModel roomModel) {
		return new ResponseEntity<Room>(roomService.addRoomDetails(roomModel), HttpStatus.CREATED);
	}
